        ...
        {fields.map((field, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className={`w-[170px] shrink-0 text-center bg-white border border-[#D9DEE6] px-3 py-1.5 rounded-md shadow-sm font-mono text-xs font-bold text-slate-800 hover:shadow-md hover:border-[#273B5E] transition-all truncate select-text cursor-default ${field.valueClass || ''}`}>
                {field.value}
              </div>
            </div>
          );
